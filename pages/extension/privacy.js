...
export default function PrivacyPage({}) {
	return (
		<div className={`container page_container d-flex justify-content-center mb-5`}>
		<div className={`col-12 col-xl-10`}>
			<h1>Privacy Policy</h1>
			<p>Last updated: January 16, 2022</p>
			<p>
			...
			<ul>
				...
				<li>
					<p>
						...
						electronic device, named Cryptostamping
					</p>
				</li>
				<li>
					<p>
						...
						to Cryptostamping, 8-1-43, Garapti Street, Amalapuram..
					</p>
				</li>
				<li>
					<p>
						<strong>Country</strong> refers to: Andhra Pradesh,
						India
					</p>
				</li>
				<li>
				...
				<li>
					<p>
						<strong>EVM Wallet</strong> is the browser crypto wallet
			...
			<h3>EVM wallet</h3>
			<p>
				The Company allows You to connect your EVM wallet. If You decide
				to connect or otherwise grant us access to your EVM wallet
				Service, We may collect Personal data that is already associated
				with Your EVM wallet{"'"}s account, such as Your wallet address,
				Your wallet balances, Your activities or Your tokens associated
				with that wallet account.
			</p>
			...
			<ul>
				<li>By email: subhakartikkireddy@gmail.com</li>
			</ul>
		</div>
		</div>
	);
